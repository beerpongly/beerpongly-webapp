...
alter table "public"."rounds" add constraint "rounds_tournament_fkey" FOREIGN KEY (tournament) REFERENCES tournaments(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."rounds" validate constraint "rounds_tournament_fkey";
