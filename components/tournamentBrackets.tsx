...
export interface Tournament {
    ...
    return (
      <div className="flex justify-start">
        ...
        <div className="box-border h-10 w-40 p-1 border-gray-400 bg-indigo-200 rounded-tr-lg">
          <p className="inline-block align-middle">{team}</p>
        </div>
      </div>
    )
  }
  ...
  export function Match({ topTeam, bottomTeam }: Matchup) {
    return (
      <main className="p-20">
        <div className="">
          <TopBracket team={topTeam.team} position={topTeam.position}/>
          <BottomBracket team={bottomTeam.team} position={bottomTeam.position}/>
        </div>
      </main>
    )
  }
